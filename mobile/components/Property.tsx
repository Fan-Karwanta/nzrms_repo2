...

{
            property.rentalTerm && (
              <View style={styles.info}>
                <MaterialIcons name="swap-horiz" size={iconSize} color={iconColor} style={styles.infoIcon} />
                <Text style={styles.text}>{helper.rentalTermUnit(property.rentalTerm)}</Text>
              </View>
            )
          }
        </View>
