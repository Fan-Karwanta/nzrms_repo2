          ...
          {mapView ? (
            <View style={styles.mapContainer}>
              <MapView
                style={styles.map}
                initialRegion={{
                  latitude: route.params.location ? 0 : 0, // Set default or get from location
                  longitude: route.params.location ? 0 : 0,
                ...
                {properties.map((property) => (
                  property.latitude && property.longitude && (
                    <Marker
                      ...
                      title={property.name}
                      description={`${property.type} - ${property.rentalTerm}`}
            ...
            <PropertyList
              ...
              onPropertiesLoad={setProperties}
              header={(
                <View>
