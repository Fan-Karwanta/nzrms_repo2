...
const CreateProperty = () => {
  ...
  const handleListingTypeChange = (e: SelectChangeEvent) => {
    setListingType(e.target.value as movininTypes.ListingType)
  }
      ...
      <div ref={createPropertyRef} className="create-property">
        <Paper className="property-form property-form-wrapper" elevation={10} style={visible ? {} : { display: 'none' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <FormControl fullWidth margin="dense">
              <InputLabel className="required" error={formError && !address}>
                {strings.ADDRESS}
              </InputLabel>
              <Input type="text" value={address} onChange={handleAddressChange} error={formError && !address} />
              <FormHelperText error={formError && !address}>
                {(formError && !address) && strings.REQUIRED}
              </FormHelperText>
            </FormControl>
            ...
            <FormControl fullWidth margin="dense">
              ...
              <Select
                ...
                label="R/S"
              >
                <MenuItem value={movininTypes.ListingType.Rent}>Rent</MenuItem>
                <MenuItem value={movininTypes.ListingType.Sale}>Sale</MenuItem>
              </Select>
            </FormControl>

            <FormControl fullWidth margin="dense">
              <TextField
                label={`${strings.PRICE} (${commonStrings.CURRENCY})`}
                slotProps={{
