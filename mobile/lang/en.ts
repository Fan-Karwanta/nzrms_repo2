...
export const en = {
  ...
  PROPERTY_TYPE_EMPTY: "Please select a property type",
  TRANSACTION_TYPE_EMPTY: "Please select a transaction type",
  FROM_DATE_EMPTY: 'Please enter the start date.',
  TO_DATE_EMPTY: 'Please enter the end date',
  BIO: 'Bio',
  ...
  CREATE_BOOKING: 'RENT',
  BOOKING_OPTIONS: 'Your Reservation Options',
  BOOKING_DETAILS: 'Your Property Details',
  DAYS: 'Days',
  COST: 'COST',
  ...
  TRANSACTION_TYPEZ: 'Transaction Type',
