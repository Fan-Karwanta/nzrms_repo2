...
const strings = new LocalizedStrings({
  ...
  en: {
    ...
    NAME: 'Name',
    PROPERTY_IMAGE_SIZE_ERROR: `Image must be ${env.PROPERTY_IMAGE_WIDTH}x${env.PROPERTY_IMAGE_HEIGHT}`,
    ...
    MINIMUM_AGE_NOT_VALID: `Minimum age must be greater than or equal to ${env.MINIMUM_AGE} years.`,
    ADDRESS: 'Address',
    DESCRIPTION: 'Description',
    BEDROOMS: 'Bedrooms',
    BATHROOMS: 'Bathrooms',
